...
train_it = train_datagen.flow_from_directory('data_8-multi-class/train/',
                                       class_mode='categorical', batch_size=64, target_size=(200, 200))
val_it = test_datagen.flow_from_directory('data_8-multi-class/val/',
                                     class_mode='categorical', batch_size=64, target_size=(200, 200))
test_it = test_datagen.flow_from_directory('data_8-multi-class/test/',
                                     class_mode='categorical', batch_size=64, target_size=(200, 200))
